  ...
  return (
    <div className="max-w-screen-lg mx-auto p-4 px-4">
      <header className="text-center mb-12">
        <h1 className="md:text-3xl text-2xl pt-8 font-bold">
          Grow with SteadFast
        </h1>
      </header>
      <div className=" rounded-lg shadow-md md:p-8 p-4 flex flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2 pr-0 md:pr-8 mb-8 md:mb-0">
          ...
          <p className="text-gray-600  mb-4">
            Steadfast courier is a leading courier service company in Bangladesh
            dedicated to delivering reliable and efficient e-commerce logistics
            solutions in time.
          </p>
          <ul className="text-gray-600 space-y-2">
            <li className="flex items-center">
              <i className="fas fa-check text-yellow-500 mr-2 "></i> Daily
              pickups, no limitations
            </li>
            <li className="flex items-center">
              <i className="fas fa-check text-yellow-500 mr-2 "></i> Faster
              Payment Service
            </li>
            <li className="flex items-center pb-4">
              <i className="fas fa-check text-yellow-500 mr-2 "></i> Cash on
              Delivery
            </li>
